...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full h-[520px] flex flex-col items-center justify-start bg-black overflow-hidden"
      ref={containerRef}
      onClick={handleContainerClick}
    >
      <div className="relative w-full max-w-4xl h-full flex items-start justify-center">
        <div
        ...
        >
          <div className="absolute w-24 h-24 flex items-center justify-center z-10">
            ...
            <img 
              ...
              className="w-40 h-40 object-contain filter brightness-125 animate-pulse"
            />
          </div>
